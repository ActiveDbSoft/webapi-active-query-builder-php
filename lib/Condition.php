...
class Condition implements ArrayAccess
{
    ...
    const CONDITION_OPERATOR_NOT_LIKE = 'NotLike';
    ...
    public function getConditionOperatorAllowableValues()
    {
        return [
            ...
            self::CONDITION_OPERATOR_LIKE,
            self::CONDITION_OPERATOR_NOT_LIKE,
        ];
    }
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = array("IsNull", "IsNotNull", "Equal", "NotEqual", "Less", "NotLess", "LessEqual", "NotLessEqual", "Greater", "NotGreater", "GreaterEqual", "NotGreaterEqual", "Between", "NotBetween", "In", "NotIn", "Like", "NotLike");
    ...
    public function setConditionOperator($condition_operator)
    {
        ...
        if (!in_array($condition_operator, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'condition_operator', must be one of 'IsNull', 'IsNotNull', 'Equal', 'NotEqual', 'Less', 'NotLess', 'LessEqual', 'NotLessEqual', 'Greater', 'NotGreater', 'GreaterEqual', 'NotGreaterEqual', 'Between', 'NotBetween', 'In', 'NotIn', 'Like', 'NotLike'");
        }
